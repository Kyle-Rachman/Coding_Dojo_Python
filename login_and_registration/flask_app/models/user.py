...
class User:
    ...
    def get_all(cls):
        ...
        results = connectToMySQL('logins_schema').query_db(query)
        users = []
        for user in results:
    ...
    def get_one(cls, id):
        ...
        data = {"id" : id}
        results = connectToMySQL('logins_schema').query_db(query, data)
    ...
    def save(cls, data):
        ...
        return connectToMySQL('logins_schema').query_db(query, data)
